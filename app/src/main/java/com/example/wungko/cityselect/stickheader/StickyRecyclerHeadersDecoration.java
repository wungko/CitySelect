...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
  ...
  private final StickHeaders mAdapter;
  ...
  public StickyRecyclerHeadersDecoration(StickHeaders adapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator());
  }

  private StickyRecyclerHeadersDecoration(StickHeaders adapter, OrientationProvider orientationProvider,
  ...
  private StickyRecyclerHeadersDecoration(StickHeaders adapter, HeaderRenderer headerRenderer,
